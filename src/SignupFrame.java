...
public class SignupFrame implements ActionListener {
    ...
    public SignupFrame(UserTable user1, ArticleTable article1) {
        this.user1 = user1;
    ...
    public void createSignupFrame() {
        ...
        sign_jf.setTitle("Insta Sign Up");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand() == "Sign Up") {
            ...
            String input_nick = new String(new_nickname.getText());

            if(user1.insertAUser(input_id, input_password, input_name, input_nick))
